...
const GeminiCredForm: FC<Props> = ({ onClose, onSave }) => {
  ...
  const saveData = () => {
    if (!apiKey || !baseUrl) {
      alert("Api key and base url reuired");
      return;
    }
    ...
    <div className="p-4 w-full ">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <Bot className="w-12 h-12 text-[#ff6f5c]" />
          <div>
            <h2 className="text-xl font-semibold">Gemini account</h2>
